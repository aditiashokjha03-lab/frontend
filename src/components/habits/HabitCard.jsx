...
export default function HabitCard({ habit }) {
    ...
    return (
        <div className="relative group p-6 rounded-[2rem] border border-border bg-card shadow-2xl shadow-black/5 hover:border-border transition-all duration-300 flex flex-col gap-5 overflow-hidden">
            ...
            <div className="flex justify-between items-start">
                <div className="flex items-center gap-5">
                    <div className="h-14 w-14 flex items-center justify-center rounded-2xl bg-secondary/50 border border-border text-2xl group-hover:bg-secondary transition-colors">
                        {habit.icon || '📌'}
                    </div>
                    <div>
            ...
            <div className="flex justify-between items-center mt-2 border-t border-border pt-5">
